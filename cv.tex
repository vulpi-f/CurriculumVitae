...
\newcommand{\sideheadinggap}{2.15mm}
\newcommand{\pubiconwidth}{5.0mm}
\newcommand{\pubicongap}{1.65mm}
  ...
  \raisebox{\sidearrowbaseline}{%
    \begin{tikzpicture}[x=\sidearrowwidth,y=\sidearrowheight,baseline=(mid.base)]
      ...
      \fill[cvteal,rounded corners=0.08mm]
        (0.00,0.00) -- (0.64,0.50) -- (0.00,1.00) -- (0.26,0.50) -- cycle;
    \end{tikzpicture}}%
...
\newcommand{\pubicon}[1]{%
  \begin{tikzpicture}[baseline=(current bounding box.north)]
    ...
    \node[inner sep=0pt,text=white,font=\fontsize{7.2}{7.2}\selectfont]
      at ($(icontop)!0.5!(iconbottom)$) {\faIcon{link}};
  \end{tikzpicture}%
}
...
\newcommand{\publication}[2]{%
  \sbox{\pubtextbox}{%
    \begin{minipage}[t]{46.2mm}\vspace{0pt}\raggedright\fontsize{10.15}{12.35}\selectfont #2\end{minipage}}%
  \setlength{\pubboxheight}{\dimexpr\ht\pubtextbox+\dp\pubtextbox\relax}%
  \noindent
  \begin{minipage}[t][\pubboxheight][t]{5.5mm}\vspace{0pt}#1{\pubboxheight}\end{minipage}%
  \hspace{\pubicongap}%
  \usebox{\pubtextbox}%
  \par\vspace{0.55mm}
}
...
\newcommand{\divider}{%
  \vspace{1.35mm}\noindent\textcolor{cvteal}{\rule{\linewidth}{0.42pt}}\par\vspace{1.45mm}
}
