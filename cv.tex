...
% - Side headings use a vector chevron drawn in TeX (not a bitmap) so its
%   vertical centre can be aligned precisely with the heading baseline.
% - Publication link badges compute their height from the text box and centre
%   the icon with TikZ interpolation; keep this pattern for entries of any
%   length.
...
\newcommand{\sideheading}[1]{%
  ...
  \raisebox{\sidearrowbaseline}{%
    \begin{tikzpicture}[x=\sidearrowwidth,y=\sidearrowheight,baseline=(mid.base)]
      \coordinate (mid) at (0.50,0.50);
      \fill[cvteal,rounded corners=0.08mm]
        (0.00,0.00) -- (1.00,0.50) -- (0.00,1.00) -- (0.35,0.50) -- cycle;
    \end{tikzpicture}}%
...
\newcommand{\pubicon}[1]{%
  \begin{tikzpicture}[baseline=(current bounding box.north)]
    ...
    \node[inner sep=0pt]
      at ($(icontop)!0.5!(iconbottom)$) {\includegraphics[width=\pubiconartwidth]{CV_link_icon.png}};
  \end{tikzpicture}%
}

\newcommand{\orcidicon}[1]{%
  \includegraphics[width=5.08mm]{CV_orcid_icon.png}%
}

\newcommand{\pubheading}[1]{%
  \vspace{0.65mm}%
  \noindent
  \raisebox{\sidearrowbaseline}{\includegraphics[width=5.08mm]{CV_orcid_icon.png}}%
  \hspace{\sideheadinggap}{\sans\bfseries\fontsize{14.5}{15.5}\selectfont #1}\par
  \vspace{0.65mm}%
}
