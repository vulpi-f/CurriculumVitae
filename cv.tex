...
\newcommand{\sideheading}[1]{%
  \vspace{0.65mm}%
  \noindent
  \raisebox{-1.0mm}{\includegraphics[width=5.05mm]{CV_side_arrow.png}}%
  \hspace{2.15mm}{\sans\bfseries\fontsize{14.5}{15.5}\selectfont #1}\par
  \vspace{0.65mm}%
}
...
\newcommand{\pubicon}[1]{%
  \begin{tikzpicture}[baseline=(current bounding box.north)]
    \path[fill=cvteal,rounded corners=1.0mm] (0pt,0pt) rectangle (5.0mm,-#1);
    \coordinate (icontop) at (2.5mm,0pt);
    \coordinate (iconbottom) at (2.5mm,-#1);
    \node[inner sep=0pt] at ($(icontop)!0.5!(iconbottom)$) {\includegraphics[width=3.0mm]{CV_link_icon.png}};
  \end{tikzpicture}%
}
