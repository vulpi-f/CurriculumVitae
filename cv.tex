...
\newcommand{\publication}[2]{%
  ...
  \hspace{1.1mm}%
  \begin{minipage}[t]{45.0mm}\vspace{0pt}\fontsize{10.2}{14.8}\selectfont #2\end{minipage}%
  \par\vspace{0.95mm}
}
...
\newcommand{\entry}[5]{%
  ...
  \vspace{0.8mm}
  {\color{cvtext}\fontsize{10.03}{13.55}\selectfont\justifying\noindent #5\par}
}
