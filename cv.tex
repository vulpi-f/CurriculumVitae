...
\newcommand{\sideheading}[1]{%
  ...
  \begin{tikzpicture}[x=1mm,y=1mm,baseline=-1.6mm]
    \fill[cvteal] (0,0) -- (5.7,3.6) -- (0,7.2) -- (2.0,3.6) -- cycle;
  \end{tikzpicture}%
  \hspace{1.75mm}{\sans\bfseries\fontsize{14.5}{15.5}\selectfont #1}\par
  \vspace{0.65mm}%
}
...
\newcommand{\publication}[2]{%
  \noindent
  \begin{minipage}[t]{6.9mm}\vspace{0pt}#1\end{minipage}%
  \hspace{1.0mm}%
  \begin{minipage}[t]{46.2mm}\vspace{0pt}\raggedright\fontsize{10.15}{14.15}\selectfont #2\end{minipage}%
  \par\vspace{0.65mm}
}
...
\newcommand{\divider}{%
  \vspace{1.9mm}\noindent\textcolor{cvteal}{\rule{\linewidth}{0.55pt}}\par\vspace{1.9mm}
}
